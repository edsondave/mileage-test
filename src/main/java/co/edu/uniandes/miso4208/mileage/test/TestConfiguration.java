package co.edu.uniandes.miso4208.mileage.test;
...
public final class TestConfiguration {
    ...
    public static final String DEFAULT_APP_UNDER_TEST_PATH = new File("com.evancharlton.mileage.apk").getAbsolutePath();
